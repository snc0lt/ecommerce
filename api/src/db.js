...
const { Product, Category, Order, User, Review, Orderproduct,Imagen } = sequelize.models
...
Orderproduct.belongsTo(Order, { as: "orden" });
Orderproduct.belongsTo(Product,{ as: "producto" } );
